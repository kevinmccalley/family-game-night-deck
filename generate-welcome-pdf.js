...
// purchase for Family Game Night Deck — native jsPDF, fixed inch coordinates.
...
const INK = [28, 20, 18];
const ACCENT = [176, 40, 38]; // red, matches the deck's own default ACCENT in app.js
const TAGLINE_GOLD = [199, 163, 88];
const DIVIDER = [214, 199, 184];
const CARD_BG = [244, 246, 248];

const DOMAIN = "family-game-night-deck.vercel.app";
...
doc.setTextColor(...INK);
const lede = "Your deck isn't in this file — it's built just for you, in about a minute, right here:";
...
const outPath = path.join(__dirname, "..", "goodstockpress", "assets", "family-game-night-deck-welcome.pdf");
